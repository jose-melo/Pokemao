...
public class ControladorDeEventos extends Constante{
	...
	static {
		for(int i = 1; i < 19; i++)
			for(int j = 1; j < 19; j++)
				multiplicador[i][j] = 1;
		multiplicador[NORMAL][PEDRA]=0.5;
		multiplicador[NORMAL][FANTASMA]=0;
		multiplicador[NORMAL][ACO]=0.5;
		multiplicador[LUTADOR][NORMAL]=2;
		multiplicador[LUTADOR][VOADOR]=0.5;
		multiplicador[1][1]=1;
		multiplicador[1][1]=1;
		multiplicador[1][1]=1;
		multiplicador[1][1]=1;
